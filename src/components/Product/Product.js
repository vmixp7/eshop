...
const Product = ({
  ...
  const { id, name, price, image, shortDescription, description ,qty_num , rate,rate_num } = product;
      ...
      >
        <Card className="product-card">
          ...
          <Card.Body>
            ...
            <Rate allowHalf defaultValue={rate} />{' '}( {rate_num} )<br />
            <h7><b> Inventory : {qty_num}</b></h7>
